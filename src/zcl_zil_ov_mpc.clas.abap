class ZCL_ZIL_OV_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZIL_OV_MPC================CP' ##NO_TEXT.
...
CLASS ZCL_ZIL_OV_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZIL_OV_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZIL_OV_MPC=>TS_MENSAGEM' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TotalItem' iv_abap_fieldname = 'TOTALITEM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZIL_OV_MPC=>TS_OVCAB' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZIL_OV_MPC=>TS_OVITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260105194445'.                  "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'TotalItem'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'OVCAB'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
